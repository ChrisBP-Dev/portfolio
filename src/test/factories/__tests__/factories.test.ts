...
describe('Factory → Schema Validation', () => {
  describe('createProject', () => {
    it('[P0] 1.4-UNIT-027: createProject() pasa projectSchema.parse()', () => {
  ...
  describe('createTechnology', () => {
    it('[P0] 1.4-UNIT-028: createTechnology() pasa technologySchema.parse()', () => {
  ...
  describe('createExperience', () => {
    it('[P0] 1.4-UNIT-029: createExperience() pasa experienceSchema.parse()', () => {
  ...
  describe('createBlogPost', () => {
    it('[P0] 1.4-UNIT-030: createBlogPost() pasa blogPostSchema.parse()', () => {
...
describe('Factory Overrides', () => {
  it('[P2] 1.4-UNIT-031: cada factory acepta y aplica overrides', () => {
    // Project overrides
...
describe('Factory Unique IDs', () => {
  it('[P2] 1.4-UNIT-032: cada factory genera IDs únicos', () => {
